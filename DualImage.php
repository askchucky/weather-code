...
#  PoP?=[YN] | ScePosition=[LMR] | Text Name (optional)
  ...
  'hur_warn' => 'Y|L|Hurrican Warning',
  'hur_watch' => 'Y|L|Hurricane Watch',
  'hurr' => 'Y|L|Hurrican Warning old',
  'hurr-noh' => 'Y|L|Hurricane Watch old',
  'hz' => 'N|L|Haze',
  'hazy' => 'N|L|Haze old',
  'hot' => 'N|R|Hot',
  'ip' => 'Y|L|Ice Pellets',
  ...
  'ts_nowarn' => 'Y|L|Tropical Storm',
  'ts_warn' => 'Y|L|Tropical Storm Warning',
  'tropstorm-noh' => 'Y|L|Tropical Storm',
  'tropstorm' => 'Y|L|Tropical Storm Warning old',
  'ts_watch' => 'Y|L|Tropical Storm Watch',
...
if($LIMG and ($leftIcon == $rightIcon) ) { # single image one or 2 PoP
  ...
  if($leftPoP > 0 and $rightPoP > 0 ) { # two PoP provided
	...
	if(abs($leftPoP-$rightPoP) >= 10) {# Draw the arrow
...
if($LIMG and $RIMG  and ! ($leftIcon == $rightIcon) ) { # dual icons, 0, 1 or 2 PoP
  ...
  if(($leftPoP > 0 and $rightPoP > 0)  and abs($leftPoP-$rightPoP) >= 10 and
